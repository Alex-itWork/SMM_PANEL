            ...
            <div class="form-body">
              <div class="row justify-content-md-center">
                ...
                <div class="col-md-12">
                  ...
                  <div class="form-group">
                    <label class="form-label">Secret Key 1<span class="form-required">*</span></label>
                    <input type="text" class="form-control"  name="payment_params[option][secret_key_1]" value="<?php echo (isset($option->secret_key_1)) ? $option->secret_key_1 : ''; ?>">
                  </div>

                  <div class="form-group">
                    <label class="form-label">Secret Key 2<span class="form-required">*</span></label>
