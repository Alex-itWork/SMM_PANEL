    ...
    <div class="row">
      <div class="col-md-12">
        <div class="for-group text-center">
          <img src="https://oleggator.ru/wp-content/uploads/2020/07/kassa.png" alt="Freekassa icon">
          <p class="p-t-10"><small><?=sprintf(lang("you_can_deposit_funds_with_paypal_they_will_be_automaticly_added_into_your_account"), 'Freekassa')?></small></p>
        </div>
